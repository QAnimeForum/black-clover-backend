...
@Injectable()
export class SpellDescriptionEditWizard {
    ...
    constructor(
        ...
        this.scene = new Scenes.WizardScene<BotContext>(
            ENUM_SCENES_ID.EDIT_SPELL_DESCRIPTION_SCENE_ID,
            this.step1()
        );
    ...
    step1() {
        ...
        composer.on(message('text'), async (ctx) => {
            ...
            if (ctx.session.editUnionSpellId) {
                ...
                await this.grimoireService.updateSpellDescription(
                    union.spell.id,
                    {
                        description: message,
                    }
                ...
                await this.grimoireService.updateSpellDescription(spellId, {
                    description: message,
                });
