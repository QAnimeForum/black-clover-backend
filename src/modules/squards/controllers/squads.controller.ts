...
import { ENUM_ARMOR_STATUS_CODE_ERROR } from '../../items/constants/armor.status-code.constant';
import { ArmorListSerialization } from '../../items/serializations/armor.list.serialization';
