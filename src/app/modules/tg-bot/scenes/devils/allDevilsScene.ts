...
import { DevilSpell } from 'src/app/modules/devils/domain/devil';
import { DevilSpellEntity } from 'src/app/modules/devils/entity/devil.spell.entity';
...
async function showSpellInfo(devilUnion: DevilUnionEntity, ctx: BotContext) {
    const caption = devilUnion.spells
        ...
        .join();
    await ctx.reply(`Единение ${devilUnion.percent}\n${caption}`);
}
/**
 * import {
    Action,
