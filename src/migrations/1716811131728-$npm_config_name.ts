...
export class  $npmConfigName1716811131728 implements MigrationInterface {
    name = ' $npmConfigName1716811131728'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "armdedForcesRequest" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tgUsername" character varying NOT NULL, "tgUserId" character varying NOT NULL, "status" "public"."armdedForcesRequest_status_enum" NOT NULL DEFAULT 'pending', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "forces_id" uuid, "character_id" uuid, CONSTRAINT "PK_5aca705cba2abc521d987c8a645" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "race" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3068b184130d87a20e516045bb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "background" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "race_id" uuid NOT NULL, "age" integer NOT NULL, "sex" character varying NOT NULL, "history" character varying NOT NULL, "appearance" character varying NOT NULL, "state_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7271b4d2e4bd0f68b3fdb5c090a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "armed_forces_member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "character_id" uuid, "ar" uuid, "rank_id" uuid, CONSTRAINT "REL_cc2cf86f1190c133290a824d70" UNIQUE ("character_id"), CONSTRAINT "PK_576b7574a9a23fdac1dc45c9d40" PRIMARY KEY ("id"))`);
